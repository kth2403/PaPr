...
/*:
 * @plugindesc (v1.4) Apresenta um medidor de HP para os chefes.
 * @author Moghunter
 *
 ...
 * HISTÓRICO
 * -----------------------------------------------------------------------------
 * v1.4 - Correção de não apresentar o HP  no efeito transformação.
 *      - Correção de apresentar o HP em inimigos ocultos.
 *
 */
