...
ysp.Preloader.GLOBAL = {
    IMAGES: [
        'system/Window',
        'characters/Actor1',
		'animations/skill_star',
		'animations/XCast2',
		'animations/test11_14_3',
		'animations/3.16폭발형2',	
		'pictures/skill_ms_star@[10-2]',
		'pictures/skill_ice2@[40-1]',
		'pictures/test11_03@[75-0.5]',
		'pictures/IceSpear@[10-1]',
		'pictures/IceSpear_direction@[5-5]',
		'pictures/IceSpear_direction@[5-16]',
		'pictures/Particle_C',
		'pictures/Particle_D',
		'pictures/Particle_E',
		'characters/item_test1',
		'characters/item_test2',
		'characters/item_test3'
    ],
