...
/*:
 * @plugindesc v1.06 Generate random maps
 ...
 * <persist>    - wont be removed from $dataMap when delete
 * =============================================================================
 * Script calls
 * ------------
...
var mapCore_game_map_eraseEvent = Game_Map.prototype.eraseEvent;
Game_Map.prototype.eraseEvent = function(eventId) {
    mapCore_game_map_eraseEvent.call(this, eventId);
    
    if(!$dataMap.events[eventId].meta.persist) {
