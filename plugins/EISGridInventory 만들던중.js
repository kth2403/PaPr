...
(function () {
  ...
  function setup() {
    ...
    //  Scene_GridInventory
    //=============================================================================    
    var Window_selectWindow = function (_Window_Selectable) {
        _inherits(Window_GridInventory, _Window_Selectable);

        function Window_SelectWindow(x, y, width, height) {
          _classCallCheck(this, Window_SelectWindow);

          return _possibleConstructorReturn(this, (Window_SelectWindow.__proto__ || Object.getPrototypeOf(Window_SelectWindow)).call(this, x, y, width, height));
        }
    ...
    var Scene_GridInventory = function (_Scene_MenuBase) {
      ...
      _createClass(Scene_GridInventory, [{
        ...
        value: function createGridInventoryWindow() {
          this._gridInventoryWindow = new Window_GridInventory(655, 185, GIParams.gridwWidth, GIParams.gridwHeight);
        ...
        value: function createCharacterWindow() {
          this._characterWindow = new Window_Character(380, 185, 250, 250);
          this.addWindow(this._characterWindow);
        }
      }, {
        key: 'createCharacterEquipWindow',
        value: function createCharacterEquipWindow() {
          this._characterEquipWindow = new Window_CharacterEquipment(380, 435, 250, 75);
      ...
      _createClass(Window_Character, [{
        ...
        value: function drawCurrentCharacter() {
          ...
          if (character !== undefined) {
            ...
            if (GIParams.spriteChoice) {
            	this.drawCharacterBattler(character.characterName(), character.characterIndex(), xPos, 110);
            }
            else this.drawCharacter(character.characterName(), character.characterIndex(), xPos, 110);
          ...
          value: function drawCharacterStats() {
              ...
              this.drawText(TextManager.param(0), 10, 90, 30);
              this.drawText(TextManager.param(1), 120, 90, 30);
              this.drawText(TextManager.param(2), 10, 130, 30);
              this.drawText(TextManager.param(4), 120, 130, 30);
              this.drawText(TextManager.param(3), 10, 170, 30);
              this.drawText(TextManager.param(7), 120, 170, 30);
              this.resetTextColor();
              this.drawText(this._actor.param(0), 10, 90, width / 2, 'right');
              this.drawText(this._actor.param(1), 120, 90, width / 2, 'right');
              this.drawText(this._actor.param(2), 10, 130, width / 2, 'right');
              this.drawText(this._actor.param(4), 120, 130, width / 2, 'right');
              this.drawText(this._actor.param(3), 10, 170, width / 2, 'right');
              this.drawText(this._actor.param(7), 120, 170, width / 2, 'right');
              if (this.showStats() && this._tempActor !== null && this._actor.param(0) !== this._tempActor.param(0)) {
                  this.changeTextColor(this.paramchangeTextColor(this._tempActor.param(0) - this._actor.param(0)));
                  this.drawText('+' + this._tempActor.param(0), 80, 90);
              }
              if (this.showStats() && this._tempActor !== null && this._actor.param(1) !== this._tempActor.param(1)) {
                  this.changeTextColor(this.paramchangeTextColor(this._tempActor.param(1) - this._actor.param(1)));
                  this.drawText('+' + this._tempActor.param(sta1tIndex), 190, 90);
              }
              if (this.showStats() && this._tempActor !== null && this._actor.param(2) !== this._tempActor.param(2)) {
                  this.changeTextColor(this.paramchangeTextColor(this._tempActor.param(2) - this._actor.param(2)));
                  this.drawText('+' + this._tempActor.param(2), 80, 130);
              }
              if (this.showStats() && this._tempActor !== null && this._actor.param(4) !== this._tempActor.param(4)) {
                  this.changeTextColor(this.paramchangeTextColor(this._tempActor.param(4) - this._actor.param(4)));
                  this.drawText('+' + this._tempActor.param(4), 190, 130);
              }
              if (this.showStats() && this._tempActor !== null && this._actor.param(3) !== this._tempActor.param(3)) {
                  this.changeTextColor(this.paramchangeTextColor(this._tempActor.param(3) - this._actor.param(3)));
                  this.drawText('+' + this._tempActor.param(3), 80, 170);
              }
              if (this.showStats() && this._tempActor !== null && this._actor.param(7) !== this._tempActor.param(7)) {
                  this.changeTextColor(this.paramchangeTextColor(this._tempActor.param(7) - this._actor.param(7)));
                  this.drawText('+' + this._tempActor.param(7), 190, 170);
              }
              this.resetTextColor();
            }
          }
