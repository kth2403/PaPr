...
(function() {
  ...
  Game_MapObj.prototype.updateOnItem = function() {
	  console.log("updateOnItem") 
	  if ($gamePlayer.screenY() < this.screenY()) {
	      if (this.intersectsWith('get', $gamePlayer)) {
	    	  $gameTemp.reserveCommonEvent(13);
		        QuasiABS.Manager.startPopup("exp", this.px, this.py, "+" + 1);
	    	    QuasiABS.Manager.startAnimation(115,this.px,this.py);
	    	  this.visible = false;
	    	  this.termin = true;
