...
//=============================================================================
 /*:
 * @plugindesc v1.2.8 Creates an extra layer that darkens a map and adds lightsources!
 * @author Terrax
 *
 * @param Player radius
...
(function() {
    ...
    var daynightcolors = [  '#111111', '#111111', '#111111', '#222222',
      						'#333333', '#444444', '#BBBBBB', '#FFFFFF',
      						'#FFFFFF', '#FFFFFF', '#FFFFFF', '#FFFFFF',
      						'#FFFFFF', '#FFFFFF', '#FFFFFF', '#DDDDDD',
      						'#CCCCCC', '#BBBBBB', '#444444', '#333333',
      						'#222222', '#111111', '#111111', '#111111' ];       						
	...
	Lightmask.prototype._updateMask = function() {
		...
		if (scriptactive == true) {	
			...
			daynightcycle = $gameVariables._data[10];
			$gameVariables.setDayNightSave(daynightcycle);
