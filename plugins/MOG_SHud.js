...
S_Hud.prototype.load_img = function() {
	...
	//this._layout2_img = ImageManager.loadSystem("Shud_A");
	this._meter2_img = ImageManager.loadSystem("Shud_C");
};
...
S_Hud.prototype.create_meter = function() {
	 ...
	 this._meter2 = new Sprite(this._meter2_img);
	 this._meter2.x = this._pos_x + Moghunter.shud_meter_x;
	 this._meter2.y = this._pos_y + Moghunter.shud_meter_y;	
