...
Scene_Skill.prototype.createQuickWindow = function() {
    ...
    var ww = 312;	//Graphics.boxWidth - this._statusWindow.width;
...
Scene_Skill.prototype.slotEquip = function(slot) {
	console.log(this);
    for (var i = 3; i < 7; i++) {
        if ($gameSystem.absKeys()[i].skillId == this.item().id) {
...
Window_QuickSlot.prototype.drawItem = function(index) {
    ...
    var icon = null;
    if(this._actor) {
    	var skillidx = $gameSystem.absKeys()[index+3].skillId;
    	if (skillidx){
