...
(function ($) {
  ...
  // hardcode for now
  $.templateEvent = {"id":9999,"name":"EV015","note":"","pages":[{"conditions":{"actorId":1,"actorValid":false,"itemId":1,"itemValid":false,"selfSwitchCh":"A","selfSwitchValid":false,"switch1Id":1,"switch1Valid":false,"switch2Id":1,"switch2Valid":false,"variableId":1,"variableValid":false,"variableValue":0},"directionFix":false,"image":{"characterIndex":0,"characterName":"","direction":2,"pattern":0,"tileId":0},"list":[{"code":0,"indent":0,"parameters":[]}],"moveFrequency":3,"moveRoute":{"list":[{"code":0,"parameters":[]}],"repeat":true,"skippable":false,"wait":false},"moveSpeed":3,"moveType":0,"priorityType":1,"stepAnime":true,"through":true,"trigger":0,"walkAnime":true}],"x":13,"y":25}
  ...
  Game_Parties.prototype.tradeItem = function(id1, id2, item, count) {
    if (this.canTrade(id1, id2)) {
      ...
      party1.loseItem(item, count, false);
      party2.gainItem(item, count, false);
    }
  };
  ...
  Game_Party.prototype.atLocation = function(mapId, x, y) {
	...
	var loc_x = $gamePlayer._realX;
	var loc_y = $gamePlayer._realY;
    return !!(loc.mapId === $gameMap.mapId() && x === loc_x && y === loc_y);
  };
  ...
  Game_Party.prototype.atRegion = function(regionId) {
	...
	var loc_x = $gamePlayer._realX;
	var loc_y = $gamePlayer._realY;
    return !!(loc.mapId === $gameMap.mapId() && $gameMap.regionId(loc_x, loc_y));
  };
  ...
  Game_Player.prototype.refreshPartyLocation = function() {    
    ...
    if (loc.mapId !== $gameMap.mapId()) {
      this.reserveTransfer(loc.mapId, loc_x, loc_y, $gameParty.direction(), 2)   
    }
    else {
      this.setPosition(loc.x, loc.y);
      //this._followers.synchronize(loc.x, loc.y, this.direction())
      this.center(loc_x, loc_y);
