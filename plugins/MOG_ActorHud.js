...
Actor_Hud.prototype.load_img = function() {
	...
	this._layoutA_img = ImageManager.loadAHud("LayoutA");
	this._layoutB_img = ImageManager.loadAHud("LayoutB");
...
Actor_Hud.prototype.refresh_position = function() {
	 ...
	 this._layout1_A.x = 323;
	 this._layout1_A.y = 455;
	 this._layout1_B.x = 329 + (300 * this._battler.mhp / 100);
	 this._layout1_B.y = 455;
	 this._layout2_A.x = 323;
	 this._layout2_A.y = 467;
	 this._layout2_B.x = 329 + (300 * this._battler.mmp / 100);// + (300 * this._battler.mhp / 100);
	 this._layout2_B.y = 467;
	 this._layout3_A.x = 323;
	 this._layout3_A.y = 479;
	 this._layout3_B.x = 629;// + (300 * this._battler.mhp / 100);
	 this._layout3_B.y = 479;
	 
 	 this._layout1.x = 329;//this._pos_x;
	 this._layout1.y = 455;//this._pos_y;
	 this._layout2.x = 329;//this._pos_x;
	 this._layout2.y = 467;//this._pos_y;
	 this._layout3.x = 329;//this._pos_x;
	 this._layout3.y = 479;//this._pos_y;
	/* if (this._face) {
...
Actor_Hud.prototype.set_hud_position = function() {
     ...
     this._hud_size[2] = Moghunter.ahud_pos_x + this._layout1_A.bitmap.width - $gameMap.tileWidth();
     this._hud_size[3] = Moghunter.ahud_pos_y + this._layout1_A.bitmap.height;	 
...
Actor_Hud.prototype.update = function() {
	...
	if (!this._layoutA_img.isReady()) {return};
	if (!this._layoutB_img.isReady()) {return};
...
Actor_Hud.prototype.update_visible = function() {
	if (this.is_hud_visible() && this.opacity < 255) {this.opacity += 10}	 
	else {
		if ($gameMessage.isBusy() || !$gameSystem._ahud_visible) {
		    this.opacity -= 10;
		} /*else {
...
Actor_Hud.prototype.is_hud_visible = function() {
	...
	if ($gamePlayer.screen_realX() < this._hud_size[0] + 259) {return true};
	if ($gamePlayer.screen_realX() > this._hud_size[1] + 224) {return true};
	if ($gamePlayer.screen_realY() < this._hud_size[2] + 395) {return true};
	if ($gamePlayer.screen_realY() > this._hud_size[3] + 48) {return true};
...
Actor_Hud.prototype.need_refresh_parameter = function(parameter) {
  switch (parameter) {
  	...
  	case 2:
		 ...
		 if (this._tp_old[1] != 100) {return true};
        break;
  	case 3:
...
Actor_Hud.prototype.create_layout = function() {
	this.removeChild(this._layout1);
	this.removeChild(this._layout1_A);
	this.removeChild(this._layout1_B);
	this.removeChild(this._layout2);
	this.removeChild(this._layout2_A);
	this.removeChild(this._layout2_B);
	this.removeChild(this._layout3);
	this.removeChild(this._layout3_A);
	this.removeChild(this._layout3_B);
	if (!this._battler) {return};
	this._layout1_A = new Sprite(this._layoutA_img);
	this.addChild(this._layout1_A);
	this._layout1_B = new Sprite(this._layoutB_img);
	this.addChild(this._layout1_B);
	this._layout2_A = new Sprite(this._layoutA_img);
	this.addChild(this._layout2_A);
	this._layout2_B = new Sprite(this._layoutB_img);
	this.addChild(this._layout2_B);
	this._layout3_A = new Sprite(this._layoutA_img);
	this.addChild(this._layout3_A);
	this._layout3_B = new Sprite(this._layoutB_img);
	this.addChild(this._layout3_B);
	
	this._layout1 = new Sprite(this._layout_img);
	this._layout1.scale.x = this._battler.mhp / 100;
	this.addChild(this._layout1);
	this._layout2 = new Sprite(this._layout_img);
	this._layout2.scale.x = this._battler.mmp / 100;
	this.addChild(this._layout2);
	this._layout3 = new Sprite(this._layout_img);
	this.addChild(this._layout3);
};
...
Actor_Hud.prototype.create_hp_meter = function() {
	...
	this._hp_meter_red.scale.x = this._battler.mhp / 100 + 0.012;
	...
	this._hp_meter_blue.scale.x = this._battler.mhp / 100 + 0.012;
...
Actor_Hud.prototype.create_mp_meter = function() {
	...
	this._mp_meter_red.scale.x = this._battler.mmp / 100 + 0.012;
	...
	this._mp_meter_blue.scale.x = this._battler.mmp / 100 + 0.012;
...
Actor_Hud.prototype.create_tp_meter = function() {
	...
	this._tp_meter_red.scale.x = 100 / 100 + 0.012;
	...
	this._tp_meter_blue.scale.x = 100 / 100 + 0.012;
...
Actor_Hud.prototype.create_maxtp_number = function() {
	...
	this._tpSlash = new Sprite(this._tpSlash_img);
	this._tpSlash.x = this._pos_x + Moghunter.ahud_maxtp_number_pos_x - 24
	this._tpSlash.y = this._pos_y + Moghunter.ahud_tp_number_pos_y + 1
	this.addChild(this._tpSlash);
...
Actor_Hud.prototype.update_tp = function() {
	if (this._tp_meter_blue) {
		...
		var tpCost = [30, 20, 10];
		var act = $gamePlayer.actor().actorId();
		if(this._tp_flow[0]) {
		   ...
		   if (this.need_refresh_parameter(2)) {
			   if(this._battler.tp < tpCost[act-1]) {
				   this.refresh_meter(this._tp_meter_blue,this._battler.tp,100,1,2,0);
				   this._tp_old = [this._battler.tp,100];
				   }
			   else {this.refresh_meter(this._tp_meter_blue,this._battler.tp,100,0,2,0)};
		   };
			var dif_meter = this.update_dif(this._tp_old_ani[0],this._battler.tp,160)
			if (this._tp_old_ani[0] != dif_meter) {this._tp_old_ani[0] = dif_meter;
    ...
    if (this._maxtp_number) {
		if (this._maxtp_number_old != 100) {this._maxtp_number_old = 100;
		this.refresh_number(this._maxtp_number,this._maxtp_number_old,this._maxtp_img_data,this._maxtp_img_data[4],0);};
	};
};
