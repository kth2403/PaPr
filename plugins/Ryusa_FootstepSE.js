...
Ryusa_Footstep_SE.get_mark = function () {
    ...
    if (this._use_region_id) {
        return $gameMap.regionId(Math.floor($gamePlayer.x), Math.floor($gamePlayer.y));
    }
    // 如果使用地形 ID
    else {
...
RyusaWorks.Ryusa_FootstepSE.Game_Player_moveByInput = Game_Player.prototype.moveByInput;
Game_Player.prototype.moveByInput = function () {
    RyusaWorks.Ryusa_FootstepSE.Game_Player_moveByInput.call(this);
